...
TEAM_APP="testcircleci"
#user token
API_TOKEN="85822b0a498f23b436ceb70837ab40a88caca114"
#app token
#API_TOKEN="891e7c1829789b9698734f7a70d0542378b7fff8"
CONTENT_TYPE="application/vnd.android.package-archive"
UPLOAD_DOMAIN="https://file.appcenter.ms/upload"
API_URL="https://api.appcenter.ms/v0.1/apps/u.elfar/$TEAM_APP"
...
# https://api.appcenter.ms/v0.1/apps/testcircleci/uploads/releases
echo ">>>" $upload_json
...
#      https://file.appcenter.ms/upload/set_metadata/null?file_name=app-release-unsigned.apk&file_size=4564715&token=null&content_type=
echo ">>>" $metadata_url
...
echo $meta_response
echo $chunk_size
APPCENTER_OUTPUT_DIRECTORY=/tmp
